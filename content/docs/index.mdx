---
title: Installation
description: Getting started with PixelUI
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui.ayushkatre.tech/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui.ayushkatre.tech/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui.ayushkatre.tech/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json
```
...
```jsx
import Card05 from "@/components/pixelui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui.ayushkatre.tech/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui.ayushkatre.tech/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui.ayushkatre.tech/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/pixelui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui.ayushkatre.tech/r/card-05.json -c ./apps/www
```
