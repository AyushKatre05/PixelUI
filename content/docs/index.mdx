...
```bash tab="bun"
bunx shadcn@latest add https://pixelui-ak.vercel.app/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui-ak.vercel.app/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui-ak.vercel.app/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui-ak.vercel.app/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui-ak.vercel.app/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui-ak.vercel.app/r/ai-card-generation.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://pixelui-ak.vercel.app/r/card-05.json -c ./apps/www
```
